...
export const EMAIL_PLACEHOLDERS: EmailPlaceholder[] = [
  ...
  { token: "welcome_code", label: "Nieuwsbrief-kortingscode", hint: "Code na aanmelden" },
...
export const DEFAULT_EMAIL_TEMPLATES: Record<EmailTemplateKey, EmailTemplateDraft> = {
  ...
  "marketing.welcome": {
    ...
    category: "marketing",
    name: "Welkomstmail",
    description: "Na nieuwsbrief-aanmelding of eerste bestelling met marketingtoestemming.",
    subject: "Welkom bij Bergasports — {{welcome_code}}",
    title: "Welkom!",
    bodyHtml: [
      "<p>Hallo {{customer_name}},</p>",
      "<p>Bedankt voor je aanmelding! Je ontvangt geselecteerde aanbiedingen, kortingen en nieuws over ons assortiment.</p>",
      "<p><strong>Jouw welkomstkorting:</strong> gebruik code <strong>{{welcome_code}}</strong> bij het afrekenen.</p>",
