...
const STRINGS = {
  nl: {
    ...
    allSkates: "Alle skeelers",
    completeSkates: "Complete skeelers",
    skateShoesNav: "Skeelerschoenen",
    skateWheelsNav: "Skeelerwielen",
    skateBearings: "Lagers",
    cyclingShoesNav: "Fietsschoenen",
    shopCollection: "Shopcollectie",
    customApparel: "Custom / maatwerk",
    allWheelsets: "Alle wielsets",
  ...
  en: {
    ...
    allSkates: "All skates",
    completeSkates: "Complete skates",
    skateShoesNav: "Skate shoes",
    skateWheelsNav: "Skate wheels",
    skateBearings: "Bearings",
    cyclingShoesNav: "Cycling shoes",
    shopCollection: "Shop collection",
    customApparel: "Custom / made-to-measure",
    allWheelsets: "All wheelsets",
    ...
    columns: [
      {
        ...
        links: [
          { href: BERGASPORTS_CATEGORY_PATHS.bikes, label: t.allBikes },
          ...
          { href: BERGASPORTS_CATEGORY_PATHS.usedBikes, label: t.usedBikes },
        ],
      },
      {
        title: t.skates,
        ...
        links: [
          { href: BERGASPORTS_CATEGORY_PATHS.speedSkates, label: t.allSkates },
          { href: BERGASPORTS_CATEGORY_PATHS.completeSkates, label: t.completeSkates },
          { href: BERGASPORTS_CATEGORY_PATHS.skateShoes, label: t.skateShoesNav },
          { href: BERGASPORTS_CATEGORY_PATHS.skateWheels, label: t.skateWheelsNav },
          { href: BERGASPORTS_CATEGORY_PATHS.skateBearings, label: t.skateBearings },
        ],
      },
      {
        ...
        links: [
          { href: BERGASPORTS_CATEGORY_PATHS.shoesClothing, label: t.viewAll },
          { href: BERGASPORTS_CATEGORY_PATHS.cyclingShoes, label: t.cyclingShoesNav },
          { href: BERGASPORTS_CATEGORY_PATHS.lafugaWear, label: t.clothing },
          { href: BERGASPORTS_CATEGORY_PATHS.lafugaCustom, label: t.customApparel },
        ],
      },
      {
        title: t.wheels,
        ...
        links: [
          { href: BERGASPORTS_CATEGORY_PATHS.wheels, label: t.allWheelsets },
          { href: BERGASPORTS_CATEGORY_PATHS.scopeOutlet, label: t.scopeOutlet },
        ],
      },
      {
        title: t.accessories,
        ...
        links: [
          { href: BERGASPORTS_CATEGORY_PATHS.accessories, label: t.allAccessories },
...
export function localizedHomePillars(locale: string) {
  ...
  return [
    ...
    },
    {
      ...HOME_PILLARS[2],
      title: "Shoes & apparel",
      text: "Nimbl cycling shoes and LaFuga apparel — fit in Dedemsvaart.",
    },
    {
      ...HOME_PILLARS[3],
      title: "Wheels",
      text: "Carbon wheelsets and Scope Outlet — for racing, gravel and training.",
    },
  ] as const;
}
