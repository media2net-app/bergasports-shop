...
export function IconProducts(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="m7.5 4.27 9 5.15M21 8.25v7.5a2 2 0 0 1-1 1.73l-7 4a2 2 0 0 1-2 0l-7-4A2 2 0 0 1 3 15.75v-7.5a2 2 0 0 1 1-1.73l7-4a2 2 0 0 1 2 0l7 4a2 2 0 0 1 1 1.73Z" />
    </svg>
  );
}
